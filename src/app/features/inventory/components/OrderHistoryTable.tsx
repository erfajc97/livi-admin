...
const STATUS_LABELS: Record<string, { label: string; class: string }> = {
  // Los estados de advertencia usan los tokens de marca, no el ámbar crudo.
  order_created: { label: 'Pendiente', class: 'bg-warning-muted text-warning' },
  ...
  order_delayed: { label: 'Retrasado', class: 'bg-warning-muted text-warning' },
