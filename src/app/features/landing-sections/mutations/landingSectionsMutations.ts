...
export function useCreateLandingSectionMutation() {
  ...
  return useMutation({
    mutationFn: (dto: CreateLandingSectionDto) =>
      landingSectionsService.create(dto),
    onSuccess: () => {
...
export function useUpdateLandingSectionMutation() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(
        error?.response?.data?.message || 'Error al actualizar la sección',
      )
    },
  })
}
...
export function useDeleteLandingSectionMutation() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(
        error?.response?.data?.message || 'Error al eliminar la sección',
      )
    },
  })
}
...
export function useRemoveProductMutation() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(
        error?.response?.data?.message || 'Error al remover el producto',
      )
    },
  })
}
